 ...
 * @author 夕雾
 * @description: jwt工具类
 * @date 2024/9/17 22:50
 */
public class JWTUtil {
    private static final long EXPIRE = 60 * 1000*60; //过期时间

    public static final SecretKey key = Keys.secretKeyFor(SignatureAlgorithm.HS512);//密钥，动态生成的密钥
